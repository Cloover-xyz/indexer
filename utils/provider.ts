...
const NETWORK_NODE_URLS: NetworkNodeUrlsType = {
  mainnet: `https://starknet-mainnet.g.alchemy.com/starknet/version/rpc/v0_7/${process.env.ALCHEMY_API_KEY}`,
  sepolia: `https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_7/${process.env.ALCHEMY_API_KEY}`,
};
